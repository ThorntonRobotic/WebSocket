...
public:
    ...
    int connect(std::string const & uri) {
        ...
        connection::ptr metadata_ptr = websocketpp::lib::make_shared<connection>(new_id, con->get_handle(), uri);
    ...
    connection::ptr get_metadata(int id) const {
...
private:
    typedef std::map<int,connection::ptr> con_list;
...
int main() {
    ...
    while (!done) {
        ...
        if (input == "quit") {
            ...
            connection::ptr metadata = endpoint.get_metadata(id);
            if (metadata) {
